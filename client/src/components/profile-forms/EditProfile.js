...
const EditProfile = ({ createProfile, history, getCurrentProfile, profile: {profile,loading} }) => {
  ...
  const handleSubmit = (e) => {
    ...
    formDatas.append("company", company);
    formDatas.append("website", website);
    formDatas.append("photo", photo);
    formDatas.append("location", location);
    formDatas.append("skills", skills);
    formDatas.append("status", status);
    formDatas.append("bio", bio);
    formDatas.append("twitter", twitter);
    formDatas.append("facebook", facebook);
    formDatas.append("linkedin", linkedin);
    formDatas.append("youtube", youtube);

    createProfile(formDatas, history);
  };
      ...
      <form className="form" onSubmit={(e) => handleSubmit(e)}>
        ...
        <div className="form-group">
          <input
            ...
            onChange={(e) => handleChange(e)}
          />
          <small className="form-text">Please upload your profile photo</small>
        </div>
